...
| Streak Re-Engagement | 48 hours after the user last opens the app, refreshed on launch and foreground | Invites the user back to a low-effort mood check-in before their CBT routine goes cold. | Mood Check-In | Title: "Check in with yourself" Body: "Your [streak count]-day streak can keep going with one 30-second mood check-in." |
